...
import { fetchServerResourceDetail } from '../../hooks/useServerResources';
...
export function ResourceDropdownContent({ serverName, health, meterWidth = 110 }: ResourceDropdownContentProps) {
  ...
  const handleDelete = useCallback(async (target: string) => {
  ...
  }, [serverName, fetchDetail, showToast]);
