 ...
 * 補足（Issue #338）: SP から NotificationCenterPanel へ到達できない点は codex レビューでも
 * Important 指摘として上がったが、「通知はいったん非表示」というユーザー決定に基づく意図的な
 * 仕様であり対応不要。復帰時は上記の通り MobileNavMenu ユーティリティ節に行を追加する。
 */
