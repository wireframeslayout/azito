export type NotificationEvent =
  ...
  | { type: 'agent:activity'; payload: { serverName: string; target: string; running: boolean; source: 'operation' | 'manual' | 'supervised'; operation: boolean; taskId?: number; label?: string; projectId?: number; status?: 'working' | 'blocked'; paneName?: string } }
